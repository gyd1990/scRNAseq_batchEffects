...
# Parameter Space
par_n = [50, 100, 200, 500] # average number of cells / batch
par_b = [1, 2, 4, 8] # factor for var of gene distros between batches
par_g = [1, 2, 3, 4] # factor for var of gene distros within batches
