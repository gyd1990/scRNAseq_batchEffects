...
```{r}
Dens(stats$propZeros, stats$batch, "proprtion of zeros", "batch", main = "Genewise Porportions of 0's")
```
...
```{r}
parm <- sapply(btchIDX, function(x) allModels$batch[[x]]$zeros$m$getPars())
allModels$group[[grpCount]]$zeros <- parm
parm
```
